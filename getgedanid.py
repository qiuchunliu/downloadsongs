...
# 歌单名字
gedan_name = (htms.find_all('ul', class_="m-cvrlst f-cb")[0]
              .find_all('li')[0].div.a.get('title'))
# 歌单的id号
gedan_id = (str(htms.find_all('ul', class_="m-cvrlst f-cb")[0]
            .find_all('li')[0].div.a.get('href')).split('=')[-1])
print(gedan_id, gedan_name)
